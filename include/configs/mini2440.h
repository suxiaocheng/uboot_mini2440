...
#define CONFIG_BOOTARGS     "console=ttySAC0,115200 root=/dev/ram init=/linuxrc rw initrd=0x31000000,0x200000 mem=64"
...
#define CONFIG_BOOTCOMMAND	"usb reset;fatload usb 0:4 0x30008000 uImage;fatload usb 0:4 0x31000000 ramdisk.gz;bootm 0x30008000"
